...
officer = st.text_input("Compliance Officer", value="AI Verification System v2.0")
...
def generate_pdf_report(data):
    ...
    disclaimer = ("This report has been generated by VeriShield AI automated KYC verification system. "
                 ...
                 "The verification was performed using AI-based deepfake liveness detection and face matching. "
                 "All findings should be reviewed by a qualified compliance officer before final decision. "
                 "This system complies with GDPR Article 22 requirements for automated decision-making "
                 "and FinCEN FIN-2024-DEEPFAKEFRAUD guidelines.")
    ...
    pdf.set_xy(10, 275)
    pdf.cell(190, 6, 'VeriShield AI | EfficientNet-B0 99.28% Accuracy | PostgreSQL Audit Trail', 0, 1, 'C')
    pdf.set_xy(10, 283)
